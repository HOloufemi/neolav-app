...
const BOT = {const BOT = {
  ...
  "coûte": "Le lavage coûte **800 FCFA/kg**. Livraison gratuite partout à Cotonou ! 😊",
  ...
  "récupérer": "Nous vous livrons votre linge directement à votre domicile ! Pas besoin de vous déplacer. Donnez-nous votre adresse lors de la commande et nous venons chez vous. 🏠",
  "récuperer": "Nous vous livrons votre linge directement à votre domicile ! Pas besoin de vous déplacer. 🏠",
  "récupér": "Nous vous livrons votre linge directement à votre domicile ! Pas besoin de vous déplacer. 🏠",
  "collecter": "Nous venons collecter votre linge à votre domicile. Prenez un RDV depuis le bouton **«RDV»** en haut de la page. 📅",
  "collecte": "Nous venons collecter votre linge à votre domicile. Prenez un RDV depuis le bouton **«RDV»** en haut de la page. 📅",
  "contact": "Vous pouvez nous contacter par Mobile Money au **01 96 28 18 86** ou **01 61 75 30 77**. 📱",
  "appeler": "Appelez-nous au **01 96 28 18 86** ou **01 61 75 30 77**. 📞",
  "numéro": "Nos numéros sont le **01 96 28 18 86** et le **01 61 75 30 77**. 📱",
  "paiement": "Nous acceptons le **MTN Mobile Money**. Envoyez sur : **01 96 28 18 86** ou **01 61 75 30 77**. 📱",
  ...
  "payer": "Vous payez par **MTN Mobile Money** après la collecte de votre linge. Numéros : **01 96 28 18 86** / **01 61 75 30 77**. 💛",
  "commande": "Pour passer commande, cliquez sur le bouton **«Commander»** en haut de la page. C'est rapide ! 📦",
  "commander": "Cliquez sur le bouton bleu **«Commander»** en haut à droite de la page pour passer votre commande ! 📦",
  "clique": "Cliquez sur le bouton bleu **«Commander»** en haut à droite de la page. Si ça ne répond pas, rafraîchissez la page et réessayez ! 😊",
  "marche pas": "Essayez de rafraîchir la page puis cliquez à nouveau sur **«Commander»**. Si le problème persiste, appelez-nous au **01 96 28 18 86**. 📞",
  "fonctionne pas": "Essayez de rafraîchir la page puis cliquez à nouveau sur **«Commander»**. Si le problème persiste, appelez-nous au **01 96 28 18 86**. 📞",
  "rien": "Je suis désolé pour ce désagrément ! Essayez de rafraîchir la page. Sinon appelez-nous directement au **01 96 28 18 86**. 📞",
  "rdv": "Cliquez sur **«RDV»** en haut de la page pour planifier votre collecte à l'heure qui vous convient. 📅",
  "rendez": "Cliquez sur **«RDV»** en haut de la page pour planifier votre collecte. 📅",
  "zone": "Nous couvrons **tout Cotonou**. Donnez-nous simplement votre quartier lors de la commande. 📍",
  "quartier": "Nous livrons dans **tous les quartiers de Cotonou** ! Akpakpa, Cadjehoun, Sikècodji, Godomey, Calavi et partout ailleurs. 📍",
  "service": "Nous proposons le **lavage au kg** avec collecte et livraison à domicile. 800 FCFA/kg, livraison gratuite ! ✨",
  "linge": "Nous lavons tous types de linge : vêtements, draps, serviettes, etc. **800 FCFA/kg**, livraison gratuite en 24h/48h. 🧺",
  "vêtement": "Nous lavons vos vêtements avec soin. **800 FCFA/kg**, collecte et livraison gratuites à domicile. ✨",
  "drap": "Oui, nous lavons aussi les draps et le linge de maison ! **800 FCFA/kg**, livraison gratuite. 🛏",
  "bonjour": "Bonjour ! 👋 Je suis l'assistant NÉOLAV. Comment puis-je vous aider aujourd'hui ?",
  "bonsoir": "Bonsoir ! 👋 Je suis l'assistant NÉOLAV. Comment puis-je vous aider ?",
  ...
  "dimanche": "Nous sommes fermés le dimanche. Nous collectons du **lundi au samedi de 8h à 18h**. 📅",
  "horaire": "Nous collectons du **lundi au samedi de 8h à 18h**. Choisissez votre créneau lors du RDV. ⏰",
  "rapide": "Oui ! Nous livrons en **24h maximum**. Service express disponible ! ⚡",
  "express": "Notre service express livre en **24h chrono** ! Commandez maintenant via le bouton **«Commander»**. ⚡",
  "problème": "Je suis désolé pour ce problème ! Appelez-nous directement au **01 96 28 18 86** et nous vous aiderons immédiatement. 📞",
  "aide": "Je suis là pour vous aider ! Vous pouvez me demander : les **tarifs**, la **livraison**, le **paiement**, comment **passer commande** ou prendre un **RDV**. 😊",
};
